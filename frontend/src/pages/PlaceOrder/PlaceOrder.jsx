      ...
      <form className="place-order" onSubmit={placeOrder}>
        <div className="place-order-left">
          ...
          <div className="multi-fields">
            <input name="firstName" value={data.firstName} onChange={onChangeHandler} type="text" placeholder="First name" required></input>
            <input name="lastName" value={data.lastName} onChange={onChangeHandler} type="text" placeholder="Last name" required></input>
          </div>
          <input name="email" value={data.email} onChange={onChangeHandler} type="Email" placeholder="Email address" required></input>
